...
def is_valid_git_repo(path: str) -> bool:
    ...
    try:
        ...
        is_work_tree = check_is_work_tree.returncode == 0 and check_is_work_tree.stdout.strip() == "true"
        ...
        is_bare = check_is_bare.returncode == 0 and check_is_bare.stdout.strip() == "true"
